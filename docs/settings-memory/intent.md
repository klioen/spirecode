...
## Proposed outcome
在 Settings 中增加 Memory 模块，只读展示 `memory_summary.md` 和 `MEMORY.md`。用户可在两个文档之间切换并手动刷新，无需打开项目或访问文件系统。
...
## Constraints
- 本次只展示 `memory_summary.md` 和 `MEMORY.md`，不展示 rollout summaries、skills、raw memories、worker log 或 SQLite 数据。
