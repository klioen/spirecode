...
Instances of abusive, harassing, or otherwise unacceptable behavior may be reported privately through [GitHub's private vulnerability reporting form](https://github.com/klioen/spirecode/security/advisories/new), with the title prefixed `Code of Conduct`, when no separate private community contact is available. Do not include security credentials or unrelated sensitive personal data.
